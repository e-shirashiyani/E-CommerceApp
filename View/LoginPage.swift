...
struct LoginPage: View {
        ...
        VStack{
            ...
            ScrollView(.vertical,showsIndicators: false){
                VStack(spacing:15){
                    ...
                    CustomTextField(icon: "envelope", title: "Email", hint: "e.shirashiyani@gmail.com",
    ...
    @ViewBuilder
      func CustomTextField(icon:String,title:String,hint:String
      ,value:Binding<String>,showPassword:Binding<Bool>)-> some View {
